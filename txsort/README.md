...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/davidjaenson/btcutil/txsort)
...
```bash
$ go get -u github.com/davidjaenson/btcutil/txsort
```
