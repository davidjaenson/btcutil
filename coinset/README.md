...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/davidjaenson/btcutil/coinset)
...
```bash
$ go get -u github.com/davidjaenson/btcutil/coinset
```
